...
with st.expander("Evaluar la calidad de un RAG APP"):
    st.write("""
        Para evaluar la calidad de una aplicación RAG, haremos algunas preguntas para las que ya conocemos las respuestas reales.
        De esta manera podemos ver si la aplicación está produciendo las respuestas correctas o si está alucinando.
    """)

uploaded_file = st.file_uploader("Cargar un documento .txt", type="txt")
...
with st.form("myform", clear_on_submit=True):
    ...
    if submitted and openai_api_key.startswith("sk-"):
        with st.spinner("Espera, por favor. Estoy trabajando en ello..."):
